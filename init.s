...
.LM36:
	call	cons_init@PLT
	.stabn	68,0,37,.LM37-.LFBB2
.LM37:
	leaq	.LC2(%rip), %rdi
	movl	$6828, %esi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,40,.LM38-.LFBB2
.LM38:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L25:
	.stabn	68,0,85,.LM57-.LFBB4
.LM57:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,88,.LM58-.LFBB4
.LM58:
	leaq	224(%rsp), %rax
	.stabn	68,0,89,.LM59-.LFBB4
.LM59:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,88,.LM60-.LFBB4
.LM60:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,89,.LM61-.LFBB4
.LM61:
	leaq	.LC5(%rip), %rdi
	.stabn	68,0,88,.LM62-.LFBB4
.LM62:
	movq	%rax, 16(%rsp)
	.stabn	68,0,89,.LM63-.LFBB4
.LM63:
	xorl	%eax, %eax
	.stabn	68,0,88,.LM64-.LFBB4
.LM64:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,89,.LM65-.LFBB4
.LM65:
	call	cprintf@PLT
	.stabn	68,0,90,.LM66-.LFBB4
.LM66:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,91,.LM67-.LFBB4
.LM67:
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,93,.LM68-.LFBB4
.LM68:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
